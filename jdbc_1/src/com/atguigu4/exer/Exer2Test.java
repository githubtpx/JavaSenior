...
//课后练习2：对表examstudent进行 增 、 查、 删操作

public class Exer2Test {

    //问题1：向表examstudent中添加一条记录
    /*
     *  Type:
     *  IDCard:
     *  ExamCard:
...
//            return ps.execute();
    ...
    public void queryWithIDCardOrExamCard(){
        ...
        if("a".equalsIgnoreCase(selection)){
            ...
            Student student = getInstance(Student.class, sql, examCard);//封装成哪个类对象
            if(student != null){
            ...
            Student student = getInstance(Student.class, sql, IDCard);//封装成哪个类对象
            if(student != null){
                System.out.println(student);
            }else{
